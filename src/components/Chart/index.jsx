...
const Chart = ({ totalAmount }) => {
  return (
    <div className="mb-[2rem] sm:mb-0 bg-white w-[35rem] sm:min-w-[37.3rem] rounded-lg p-[3.5rem] flex flex-col self-baseline justify-center items-center">
      <div className="w-[16.3rem]">
        <div className="text-center mb-4">
          <h3>Total Balance</h3>
          <h1 className="text-[2.4rem] text-black font-semibold">
